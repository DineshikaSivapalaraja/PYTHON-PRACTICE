...
print("In two weeks and 3days it will be", str(now+timedelta(weeks=2, days=3)))
...
# calculate tomorrow's date. Which option should you choose
today = date.today()
...
print(tomorrow)  #A,B are correct